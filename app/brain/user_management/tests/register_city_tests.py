...
class RegisterCityTests(unittest.TestCase):
    ...
    @patch('app.brain.user_management.loginerator.UsersService.user_with_email_already_exists')
    @patch.object(RegisterCity, '_user_email_is_valid')
    ...
    @patch('app.brain.user_management.loginerator.UsersService.add_user_to_database')
    @patch('app.brain.user_management.loginerator.UsersService.user_with_email_already_exists')
    @patch.object(RegisterCity, '_user_email_is_valid')
